...
- Usage: Reference from command with `@E:/Projects/team-mavericks-web/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to E:/Projects/team-mavericks-web/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/Projects/team-mavericks-web/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
