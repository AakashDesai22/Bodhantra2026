...
<!-- For checkpoint task examples and patterns, see @E:/Projects/team-mavericks-web/.gemini/get-shit-done/references/checkpoints.md -->
...
See `E:/Projects/team-mavericks-web/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/Projects/team-mavericks-web/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/Projects/team-mavericks-web/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
