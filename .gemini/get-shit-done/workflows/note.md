...
- **Global scope**: `E:/Projects/team-mavericks-web/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `E:/Projects/team-mavericks-web/.gemini/notes/`)
...
2. Glob `E:/Projects/team-mavericks-web/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (E:/Projects/team-mavericks-web/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `E:/Projects/team-mavericks-web/.gemini/notes/` — works in any directory
